...
#define configMAX_PRIORITIES			( 6 )  //( 16 )
...
function. */
#define configLIBRARY_LOWEST_INTERRUPT_PRIORITY			0xf  //系统可管理的最低优先级 (这里指的是stm32的中断，数值越小越优先级越高，现在可以管理5~15的优先级)
...
#define configKERNEL_INTERRUPT_PRIORITY 		( configLIBRARY_LOWEST_INTERRUPT_PRIORITY << (8 - configPRIO_BITS) ) //左移(8-4)位
