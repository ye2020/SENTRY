...
extern void Correct_Yaw_Zero(gimbal_control_t *fir_gimbal_correct);        //yaw光电校正
//extern void Correct_Sec_Yaw_Zero(gimbal_second_control_t *sec_gimbal_correct);    //副yaw光电校正
